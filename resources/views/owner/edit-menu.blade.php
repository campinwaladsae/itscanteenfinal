        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success : function name(data) {
                    ...
                    var gbr = JSON.parse(res.gambar);
                    console.log(gbr);
                    gbr.forEach(element => {
                        $('#list-gambar').prepend(`
                        <button class="btn btn-gambar" data-url="${element}">
                            <img src="${window.location.origin + "/storage/menu/" + element}" class="img-fluid text-left mr-1" style="height: 85px;width: 85px;object-fit:cover;border-radius: 10px" alt="">
                        </button>
                    `)
                    });
                }
